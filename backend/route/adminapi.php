...
// PC端管理后台 - /admin/api/* 前缀
Route::group('admin/api', function () {
    // 登录接口（无需认证）
    Route::post('login/account', 'adminapi/auth.Login/account');
    ...
    Route::group('', function () {
        ...
        // 消息通知
        Route::get('notice/lists', 'Notice/lists');
        Route::get('notice/detail', 'Notice/detail');
        Route::post('notice/send', 'Notice/send');
        Route::post('notice/edit', 'Notice/edit');
        Route::post('notice/delete', 'Notice/delete');
        Route::post('notice/read', 'Notice/read');
        Route::get('notice/unread_count', 'Notice/unreadCount');
