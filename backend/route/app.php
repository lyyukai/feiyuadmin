 ...
 *
 * 路径规范：
 *   /adminapi/xxx   ← 后台管理 PC 端
 *   /pcapi/xxx     ← 前台 PC 端
 *   /mobileapi/xxx  ← 移动端 H5
 */
...
Route::group('adminapi', function () {
    ...
    Route::get('form/detail', [\app\adminapi\controller\FormController::class, 'detail']);
    Route::post('form/add', [\app\adminapi\controller\FormController::class, 'add']);
    Route::post('form/edit', [\app\adminapi\controller\FormController::class, 'edit']);
    Route::post('form/delete', [\app\adminapi\controller\FormController::class, 'delete']);
    Route::get('form/data', [\app\adminapi\controller\FormController::class, 'data']);
    Route::post('form/data/delete', [\app\adminapi\controller\FormController::class, 'deleteData']);
...
Route::group('pcapi', function () {
    // 首页数据
    Route::get('index/banner', [\app\adminapi\controller\pc\IndexController::class, 'banner']);
    Route::get('index/notice', [\app\adminapi\controller\pc\IndexController::class, 'notice']);

    // 公共数据（无需登录）
    Route::get('article/lists', [\app\adminapi\controller\pc\ArticleController::class, 'lists']);
    Route::get('article/detail', [\app\adminapi\controller\pc\ArticleController::class, 'detail']);

    // 需要登录的操作
    Route::get('user/info', [\app\adminapi\controller\pc\UserController::class, 'info']);
    Route::post('user/edit', [\app\adminapi\controller\pc\UserController::class, 'edit']);
    Route::post('user/avatar/edit', [\app\adminapi\controller\pc\UserController::class, 'editAvatar']);
    Route::post('user/password/edit', [\app\adminapi\controller\pc\UserController::class, 'editPassword']);

    // 收藏
    Route::get('favorites/lists', [\app\adminapi\controller\pc\FavoritesController::class, 'lists']);
    Route::post('favorites/add', [\app\adminapi\controller\pc\FavoritesController::class, 'add']);
    Route::post('favorites/delete', [\app\adminapi\controller\pc\FavoritesController::class, 'delete']);

    // 订单
    Route::get('order/lists', [\app\adminapi\controller\pc\OrderController::class, 'lists']);
    Route::get('order/detail', [\app\adminapi\controller\pc\OrderController::class, 'detail']);
    Route::post('order/create', [\app\adminapi\controller\pc\OrderController::class, 'create']);
    Route::post('order/cancel', [\app\adminapi\controller\pc\OrderController::class, 'cancel']);
...
Route::group('mobileapi', function () {
    // 首页
    Route::get('index/banner', [\app\adminapi\controller\mobile\IndexController::class, 'banner']);
    Route::get('index/notice', [\app\adminapi\controller\mobile\IndexController::class, 'notice']);

    // 公共数据
    Route::get('article/lists', [\app\adminapi\controller\mobile\ArticleController::class, 'lists']);
    Route::get('article/detail', [\app\adminapi\controller\mobile\ArticleController::class, 'detail']);

    // 用户
    Route::get('user/info', [\app\adminapi\controller\mobile\UserController::class, 'info']);
    Route::post('user/edit', [\app\adminapi\controller\mobile\UserController::class, 'edit']);
    Route::post('user/avatar/edit', [\app\adminapi\controller\mobile\UserController::class, 'editAvatar']);

    // 收藏
    Route::get('favorites/lists', [\app\adminapi\controller\mobile\FavoritesController::class, 'lists']);
    Route::post('favorites/add', [\app\adminapi\controller\mobile\FavoritesController::class, 'add']);
    Route::post('favorites/delete', [\app\adminapi\controller\mobile\FavoritesController::class, 'delete']);

    // 订单
    Route::get('order/lists', [\app\adminapi\controller\mobile\OrderController::class, 'lists']);
    Route::get('order/detail', [\app\adminapi\controller\mobile\OrderController::class, 'detail']);
    Route::post('order/create', [\app\adminapi\controller\mobile\OrderController::class, 'create']);
    Route::post('order/cancel', [\app\adminapi\controller\mobile\OrderController::class, 'cancel']);

    // 反馈
    Route::get('feedback/lists', [\app\adminapi\controller\mobile\FeedbackController::class, 'lists']);
    Route::post('feedback/add', [\app\adminapi\controller\mobile\FeedbackController::class, 'add']);
