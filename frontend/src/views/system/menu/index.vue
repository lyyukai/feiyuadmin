...
// Element Plus 常用图标列表（已验证均存在）
const iconList = [
  'User','UserFilled','Avatar','List','Setting','Tools','Monitor',
  'Folder','FolderOpened','Document','DocumentChecked','Tickets','Collection',
  'DataAnalysis','DataBoard','PieChart','Histogram',
  'Grid','Menu','Operation','Share','Connection','Link',
  'Position','Location','LocationInformation','Place','School',
  'OfficeBuilding','HomeFilled','House','Shop','Goods','GoodsFilled',
  'PriceTag','Discount','Sell','ShoppingCart','ShoppingCartFull','ShoppingTrolley',
  'Bell','BellFilled','ChatDotRound','ChatDotSquare',
  'ChatLineRound','ChatLineSquare','ChatRound','ChatSquare','Phone','PhoneFilled',
  'VideoCamera','VideoCameraFilled','Camera','CameraFilled','Microphone','Headset',
  'Medal','Trophy','Pointer','Aim','Guide','Compass','MapLocation','Coordinate',
  'Clock','Timer','Stopwatch','Calendar','Filter','Sort','SortUp','SortDown',
  'Rank','TrendCharts','DataLine','Promotion',
  'CoffeeCup','IceCream','IceCreamRound','IceCreamSquare','Dessert','Dish','Bowl','KnifeFork',
  'View','Odometer','Key','Lock','Unlock','Edit','EditPen','Brush',
  'Delete','DeleteFilled','Plus','Minus','Close',
  'Check','CircleCheck','CircleCheckFilled','CircleClose','CircleCloseFilled',
  'SuccessFilled','InfoFilled','WarningFilled','QuestionFilled',
  'Switch','ArrowLeft','ArrowRight','ArrowUp','ArrowDown',
  'DArrowLeft','DArrowRight','ArrowLeftBold','ArrowRightBold',
  'ArrowUpBold','ArrowDownBold','Back','Top','Bottom','TopRight','TopLeft','BottomRight','BottomLeft',
  'Upload','UploadFilled','Download','Paperclip','SetUp',
  'Refresh','RefreshLeft','RefreshRight','CopyDocument','DocumentCopy',
  'Message','Search','Remove','Stamp','Wallet','Coin','Money','CreditCard','Bankcard',
  'Files','FolderAdd','FolderDelete','Mail','MailOpen','Envelope','Crop','Cooking','Food',
  'Orange','Apple','Lemon','Grape'
]
